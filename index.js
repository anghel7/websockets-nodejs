  ...
  setInterval(() => {
    wss.clients.forEach(function each(client) {
      if (client.readyState === WebSocket.OPEN) {
        let planet = {...planetList[getRandomIntInclusive(0, 9)]};
        planet.name = planet.name + " " + getRandomIntInclusive(1111, 9999);
        client.send(JSON.stringify(planet));
      }
    });
  }, 2000);
...
server.listen(9000);
console.log("Servidor funcionando. Utiliza ws://localhost:9000 para conectar.")
